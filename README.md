...
<style>
	.inline-img { float: right; width: 300px; margin: 0 0 10px 12px; height: auto; }
	.block-img { display: block; margin: 12px auto; max-width: 900px; width: 100%; height: auto; }
	@media (max-width: 800px) { .inline-img { float: none; display: block; margin: 8px auto; } }
</style>
